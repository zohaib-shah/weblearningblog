...
Lets handle the `Uncaught TypeError` using [null coalescing operator](https://www.weblearningblog.com/javascript/understanding-null-coalescing-and-ternary-operator-with-truthy-and-falsy-values-in-javascript/" target="_blank" rel="noreferrer noopener).
